...
public class RecalculaImpostosDevolucao {

	public RecalculaImpostosDevolucao() {
	}
	...
	private void execCalculoPIS( String dataIni, String datafim ) throws Exception {
		...
		try {
			...
			sqlRegistros.appendSql("  where codtipoper in ( 20,21,22)");  
			sqlRegistros.appendSql("    and tipmov = 'D'"); 
			sqlRegistros.appendSql("    and codcfo = 1202");
