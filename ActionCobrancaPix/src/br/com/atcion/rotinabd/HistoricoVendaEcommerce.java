...
public class HistoricoVendaEcommerce implements ScheduledAction {
	...
	private void insereHistoricoVendaAFV() throws Exception {
		deletaCabecalhoHistoricoPedAFV();
		deletaItensCabecalhoHistoricoPedAFV();
		insereCabecHistoricoPedidosAFV();
		insereItemHistoricoPedidosAFV();
		insereCabecHistoricoPedidosRefaturadosAFV();
		insereItemHistoricoPedidosRefaturadosAFV();
		insereHistoricoCabecPedidosDuplicPorRegiaoEcom();
		insereHistoricoItemPedidosDuplicPorRegiaoEcom();
	}

	private void deletaCabecalhoHistoricoPedAFV() throws Exception {
		...
		try {
			...
			// log = e.getMessage() + " / " + sql.toString();
			e.printStackTrace();
		}
	}

	private void deletaItensCabecalhoHistoricoPedAFV() throws Exception {
	...
	private void insereCabecHistoricoPedidosAFV() throws Exception {
	...
	private void insereCabecHistoricoPedidosRefaturadosAFV() throws Exception {
	...
	private void insereItemHistoricoPedidosAFV() throws Exception {
	...
	private void insereItemHistoricoPedidosRefaturadosAFV() throws Exception {
	...
	private void insereHistoricoCabecPedidosDuplicPorRegiaoEcom() throws Exception {
	...
	private void insereHistoricoItemPedidosDuplicPorRegiaoEcom() throws Exception {
		...
		try {
			...
			sqlGeraScript.appendSql("       || ''' , ''' ");
			sqlGeraScript.appendSql(
					"       || NVL(Round(Sum(( ITE.VLRTOT - ITE.VLRDESC ) * ITE.ATUALESTOQUE *- 1), 2), 0) ");
			sqlGeraScript.appendSql("       || ''' , ' ");
			sqlGeraScript.appendSql("       || 'null' ");
			sqlGeraScript.appendSql("       || ' , ' ");
			sqlGeraScript.appendSql("       || 'null' ");
